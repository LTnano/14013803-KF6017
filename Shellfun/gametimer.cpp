...
// changed throttling multiplier
// added code to stop a long frame during pauses
...
void GameTimer::mark()
{
	...
	else
	{
		...
		// Gradually ease off the throttling - originally 0.95, editted to 0.35 - 14013803
		mdThrottledFrameTime *= 0.35;
		...
		// prevent large frame times for errant worm parts escaping reality - 14013803
		if (mdFrameTime > 0.02)
		{
			mdFrameTime = 0.01;
		}
